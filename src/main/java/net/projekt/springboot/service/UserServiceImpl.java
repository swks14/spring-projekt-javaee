...
public class UserServiceImpl implements UserService{
    ...
    public User save(UserRegistrationDto registrationDto) {
        User user = new User(registrationDto.getFirstName(),
                registrationDto.getLastName(), registrationDto.getEmail(), registrationDto.getCountry(), passwordEncoder.encode(registrationDto.getPassword()),
                registrationDto.getUsername(), Arrays.asList(new Role("ROLE_USER")));
    ...
    public User saveAdmin(UserRegistrationDto registrationDto) {
        User user = new User(registrationDto.getFirstName(),
                registrationDto.getLastName(), registrationDto.getEmail(), registrationDto.getCountry(), passwordEncoder.encode(registrationDto.getPassword()),
                registrationDto.getUsername(), Arrays.asList(new Role("ROLE_ADMIN")));
